...
public class LivrariaMvcApplication {
    ...
    @Bean
    public CommandLineRunner demo(IUsuarioDAO usuarioDAO, BCryptPasswordEncoder encoder, IEmpresaDAO empresaDAO, ILivroDAO livroDAO) {
        return (args) -> {
            ...
            e1.setNome("Tech Solutions");
            e1.setDescricao("Empresa especializada em soluções corporativas de TI.");
            e1.setCidade("São Paulo");
            empresaDAO.save(e1);

            Empresa e2 = new Empresa();
            e2.setCNPJ("71.150.470/0001-40");
            e2.setNome("Innovatech");
            e2.setDescricao("Inovação em tecnologia da informação para empresas.");
            e2.setCidade("Rio de Janeiro");
            empresaDAO.save(e2);

            Empresa e3 = new Empresa();
            e3.setCNPJ("32.106.536/0001-82");
            e3.setNome("Cloud Computing Co.");
            e3.setDescricao("Serviços de computação em nuvem e infraestrutura de TI.");
            e3.setCidade("Porto Alegre");
            empresaDAO.save(e3);
